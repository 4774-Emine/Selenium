 ...
 */
    ...
    public void test() {
        ...
        String firstPageHandle = driver.getWindowHandle();//yeni pencere açılmadan önce ana pencerenin id sini kaydedeli
        ...
        for (String e : allWindowHandle) {
            if (!e.equals(firstPageHandle)) {
                secondPageHandle = e;
            }
