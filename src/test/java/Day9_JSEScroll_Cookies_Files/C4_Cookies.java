...
/*
    ...
    public void testCookie() {
        ...
        Cookie cookie = driver.manage().getCookieNamed("protein");//cookie yi ismiyle çağırdık
        Assert.assertEquals("chicken", cookie.getValue());//getirdiğimiz cookie doğru mu ona bakıyoruz
...
*/
        ...
        int numCookie = cookies.size();
        System.out.println("numCookie = " + numCookie);
        Cookie cay = new Cookie("demli", "çay");
        driver.manage().addCookie(cay);
        System.out.println("cay cookie eklendi");
        System.out.println("yeni cookie:" + driver.manage().getCookieNamed("demli").getValue());
        driver.manage().deleteCookie(cay);
        driver.manage().deleteAllCookies();
        Set<Cookie> sonCookies = driver.manage().getCookies();
        System.out.println("Delete sonrası cookies " + sonCookies.size());
    }
