...
/*    go to url : https://api.jquery.com/dblclick/
    ...
    public void doubleClickButton() {
        ...
        driver.switchTo().frame(0);//iframe in içine girdik önce
        ...
        System.out.println(blueBox.getCssValue("colour before:" + blueBox.getCssValue("background-color")));//rengini doğrularız
        Actions act = new Actions(driver);
        act.doubleClick(blueBox).perform();
        System.out.println(blueBox.getCssValue("colour before:" + blueBox.getCssValue("background-color")));
